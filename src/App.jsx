        ...
        <button
          onClick={() => {
            ...
            document
              ...
              ?.scrollIntoView({ behavior: "smooth" }); // Scroll to contact form
          }}
          className="px-10 py-3 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 
                     hover:from-pink-500 hover:to-orange-400 text-white transition shadow-md text-lg"
        >
          Get in Touch
        </button>
      </div>
