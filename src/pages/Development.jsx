    ...
    <div className="min-h-screen bg-gray-900 text-white relative">
      <div className="text-center pt-24 pb-10">
        <h1 className="text-4xl font-bold">
          Development <span className="text-blue-500">Tools</span>
        </h1>
        <p className="text-gray-400 mt-2">Technologies powering backend and full-stack development.</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 p-8 max-w-6xl mx-auto">
        {devTools.map((tool) => (
          <motion.div
            ...
            cursor-pointer hover:shadow-blue-500/40 hover:border-blue-400 transition-all duration-300"
